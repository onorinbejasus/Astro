    ...
    $.getJSON("./lib/webgl/SDSSFieldQuery.php?ra=" + ra + "&dec=" + dec + "&radius=			" + radius + "&zoom=0", function(data) {
      return $.each(data, function(key, val) {
        ...
        if (key % 2 === 0) {
          ...
          return _this.tiles.push(new Tile(_this.SkyView.gl, _this.SkyView.Math, "SDSS", "sky", "http://astro.cs.pitt.edu/sdss2degregion00/" + val, "http://das.sdss.org/imaging/2883/40/corr/3/" + fits, null));
        }
      });
    });
    return $.ajaxSetup({
