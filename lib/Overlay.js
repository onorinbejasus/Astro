...
(function() {
  ...
  Tile = (function() {
    ...
    function Tile(gl, Math, survey, type, texture, fits, range) {
      ...
      if (type === "sky") {
        ...
        if (this.survey === "FIRST") {
          ...
          this.proj.init(imgURL, fits, this, this.survey);
        }
      } else if (type === "anno") {
    ...
    Tile.prototype.createTile = function(ra, dec) {
      var coord, coords, cosPhi, cosTheta, indexData, phi, radius, sinPhi, sinTheta, textureCoordData, theta, vertexPositionData, x, y, z, _i, _len;
      radius = 1;
      vertexPositionData = [];
      textureCoordData = [];
      if ((ra != null) && (dec != null)) {
  ...
  Overlay = (function() {
    ...
    Overlay.prototype.createSDSSOverlay = function() {
      var dec, ra, radius, temp_this,
        _this = this;
      temp_this = this;
      radius = ((-this.SkyView.translation[2] + 1) * 15) * 360;
      radius /= 5;
      if (radius < 1.0) {
        radius = 1.0;
      }
      ...
      this.refresh = function() {
        var done, pos;
          ...
          }, _this.SkyView.render());
        };
        pos = _this.SkyView.getPosition();
        return $.get("./lib/db/remote/SDSSFieldQuery.php?ra=" + pos.ra + "&dec=" + pos.dec + "&radius=" + radius + "&zoom=30", done, 'json');
      };
      this.refresh();
    ...
    */
    ...
    Overlay.prototype.createAnnoOverlay = function(raDec, raMin, raMax, decMin, decMax, color, label) {
      var height, img, imgURL, range, tile, width,
        _this = this;
      img = '';
      $.ajaxSetup({
        'async': false
