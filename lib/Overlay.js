...
Overlay = (function() {
  ...
  Overlay.prototype.createFIRSTOverlay = function() {
    ...
    ffile.onload = function(e) {
      var image, index, lines, text, _i, _len, _ref, _results;
      ...
      for (index = _i = 0, _len = _ref.length; _i < _len; index = ++_i) {
        image = _ref[index];
        if (index < 2) {
          _results.push(_this.tiles.push(new Tile(_this.SkyView.gl, SkyView.Math, "FIRST", "sky", "./firstimages/" + image, "", null)));
        }
      }
      return _results;
    };
  ...
  Overlay.prototype.createLSSTOverlay = function() {
    ...
    lfile.onload = function(e) {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        image = _ref[_i];
        _results.push(_this.tiles.push(new Tile(_this.SkyView.gl, _this.SkyView.Math, "LSST", "sky", "../../../lsstimages/" + image, "", null)));
      }
      return _results;
    };
    lfile.send();
    ...
    $.getJSON("./lib/webgl/SDSSFieldQuery.php?ra=" + ra + "&dec=" + dec + "&radius=			" + radius + "&zoom=0", function(data) {
      return $.each(data, function(key, val) {
        ...
        if (key % 2 === 0) {
          ...
          return _this.tiles.push(new Tile(_this.SkyView.gl, _this.SkyView.Math, "SDSS", "sky", "../../sdss2degregion00/" + val, "/afs/cs.pitt.edu/projects/admt/web/sites/astro/sdss2degregion00/headtext/" + fits, null));
        }
      });
    });
    return $.ajaxSetup({
  ...
  Overlay.prototype.createAnnoOverlay = function(raDec, raMin, raMax, decMin, decMax, color, label) {
    var img, imgURL, range, scale, tile,
      _this = this;
    ...
    tile = new Tile(this.gl, this.Math, "anno", "anno", imgURL, null, range);
