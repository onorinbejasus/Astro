...
SkyView = (function(_super) {
  ...
  SkyView.lsstarray = null;

  SkyView.firstarray = null;
  ...
  function SkyView(options) {
    ...
    this.setLSSTAlpha = __bind(this.setLSSTAlpha, this);

    this.setFIRSTAlpha = __bind(this.setFIRSTAlpha, this);
    ...
    */
    ...
    lfile.onload = function(e) {
      ...
      _this.lsstflag = true;
      if (_this.firstflag === true && _this.lsstflag === true) {
  ...
  SkyView.prototype.setFIRSTAlpha = function(value) {
    this.SDSSalpha = value;
    return this.render();
  };

  SkyView.prototype.setLSSTAlpha = function(value) {
    this.LSSTalpha = value;
    return this.render();
  };
  ...
  SkyView.prototype.createOverlay = function(raDec, raMin, raMax, decMin, decMax, color, label) {
    ...
    */
    ...
    overlay = new HTM(this.gl, this.Math, "anno", "anno", imgURL, null, range, label);
    this.gridBlocks.push(overlay);
    return overlay;
  };

  SkyView.prototype.deleteOverlay = function(name) {
    var grid, i, _i, _len, _ref;
    i = 0;
    _ref = this.gridBlocks;
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      grid = _ref[_i];
      if (grid.name === name) {
        this.gridblocks.splice(i, 1);
      }
      i++;
    }
  };
  ...
  SkyView.prototype.render = function(flag) {
    var dec, grid, image, ra, radius, _i, _j, _len, _len1, _ref, _ref1,
      _this = this;
    if ((flag != null) && flag === true) {
      ...
      $.getJSON("./lib/webgl/SDSSFieldQuery.php?ra=" + ra + "&dec=" + dec + "&radius=				" + radius + "&zoom=0", function(data) {
        return $.each(data, function(key, val) {
          ...
          if (key % 2 === 0) {
            ...
            return _this.gridBlocks.push(new HTM(_this.gl, _this.Math, "sky", "SDSS", "./lib/webgl/sdss/" + val, "/afs/cs.pitt.edu/projects/admt/web/sites/astro/sdss2degregion00/headtext/" + fits));
          }
        });
      });
      $.ajaxSetup({
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        this.gridBlocks.push(new HTM(this.gl, this.Math, "sky", "LSST", "../../../lsstimages/" + image, ""));
      }
      /*
    ...
    for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
      ...
      if (grid.getSet() === true) {
        ...
        if (grid.survey === "SDSS") {
          ...
          this.gl.uniform1f(this.shaderProgram.alphaUniform, grid.alpha);
        } else if (grid.survey === "LSST") {
          this.gl.disable(this.gl.DEPTH_TEST);
          this.gl.enable(this.gl.BLEND);
          this.gl.blendFunc(this.gl.SRC_ALPHA, this.gl.ONE);
          this.gl.uniform1f(this.shaderProgram.alphaUniform, this.LSSTalpha);
        }
        /*
