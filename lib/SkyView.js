...
SkyView = (function(_super) {
  ...
  SkyView.prototype.mousePress = function(key) {
    var dir, far, matrices, near, origin, success, tri, triangle, _i, _len;
    ...
    origin = [0.0, 0.0, 0.0];
    origin = this.Math.subtract(origin, this.translation);
    dir = this.Math.norm(dir);
    console.log(dir);
    tri = this.HTM.getTriangles();
    for (_i = 0, _len = tri.length; _i < _len; _i++) {
      triangle = tri[_i];
      this.Math.intersectTri(origin, dir, triangle);
    }
  };
