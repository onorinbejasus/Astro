...
SkyView = (function(_super) {
  ...
  SkyView.prototype.drawTriangle = function(point) {
    this.ctx.beginPath();
  ...
  SkyView.prototype.octaCurse = function(points, level) {
    ...
    console.log("p1", p1);
    console.log("p2", p2);
    newTri = [[p2, p1, points[2]], [points[0], p0, p2], [p0, points[1], p1], [p0, p1, p2]];
    if (level === 0) {
      this.drawTriangle(newTri[0]);
      this.drawTriangle(newTri[1]);
      this.drawTriangle(newTri[2]);
      return this.drawTriangle(newTri[3]);
    } else {
  ...
  SkyView.prototype.render = function() {
    ...
    for (_i = 0, _len = tri.length; _i < _len; _i++) {
      ...
      if (this.level === 0) {
        ...
        this.octaCurse([point0, point1, point2], this.level - 1);
      }
    }
  };
