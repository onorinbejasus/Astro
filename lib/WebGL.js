...
WebGL = (function() {
  ...
  */
  ...
  WebGL.prototype.initShaders = function() {
    var fragmentShader, i, shaderProgram, vertexShader, _i;
    ...
    shaderProgram.texturePosAttribute = this.gl.getAttribLocation(shaderProgram, "aTexturePos");
    this.gl.enableVertexAttribArray(shaderProgram.texturePosAttribute);
    ...
    for (i = _i = 1; _i <= 16; i = ++_i) {
      shaderProgram.sampler.push(this.gl.getUniformLocation(shaderProgram, "sampler" + i));
    }
    shaderProgram.alphaUniform = this.gl.getUniformLocation(shaderProgram, "alpha");
