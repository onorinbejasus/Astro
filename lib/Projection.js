  ...
  Projection = (function() {
    ...
    Projection.prototype.init = function(image, fits, Tile, survey) {
      ...
      if (survey === "LSST" || survey === "FIRST") {
        ...
        $.getJSON("./lib/skyview/imageHeader.php?url=" + image + "&survey=" + survey + "&type=JPEG", function(data) {
        ...
        $.getJSON("./lib/skyview/imageHeader.php?url=" + fits + "&type=TEXT&survey=" + survey, function(data) {
          return $.each(data, function(key, val) {
            if (key === "CRVAL_1") {
              _this.parameters.crval1 = val;
            }
